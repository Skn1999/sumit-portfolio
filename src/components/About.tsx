  ...
  return (
    <section id="about" className="py-24 px-6 section-alt">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h2
            className={`heading-primary text-4xl md:text-5xl font-bold text-center mb-20 mode-transition ${
              ...
              {journey.map((item, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      className={`md:absolute md:top-0 md:w-[calc(50%-3rem)] ${
                        isLeft
                          ? "md:right-[calc(50%+3rem)]"
                          : "md:left-[calc(50%+3rem)]"
                      }`}
                    >
                      ...
                      >
                        ...
                        <h3
                          className={`text-xl md:text-2xl mt-1 mode-transition ${
