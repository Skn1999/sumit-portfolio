  ...
  const engineerProjects = [
    {
      ...
      description: "Built a scalable microservices architecture handling 100K+ daily users with React, Node.js, and PostgreSQL.",
    ...
    },
    {
      ...
      description: "Developed a real-time data visualization platform with WebSocket integration and custom charting components.",
    ...
    },
    {
      ...
      description: "Designed and implemented a secure authentication system and API gateway serving multiple microservices.",
  ...
  const designerProjects = [
    {
      ...
      description: "Led UX research and redesign for a patient portal, improving task completion rate by 45% through iterative testing.",
    ...
    },
    {
      ...
      description: "Created a comprehensive design system with 100+ components, ensuring consistency across multiple products.",
    ...
    },
    {
      ...
      description: "Designed an intuitive mobile banking interface focused on accessibility and clarity for diverse user groups.",
      tech: ["Mobile Design", "Accessibility", "User Flows", "Interaction Design"],
      behance: "#",
      case: "#"
    }
  ];
                ...
                {isEngineer ? (
                  ...
                  <>
                    <Button
                      ...
                      asChild
                    >
                      <a href={(project as any).behance} target="_blank" rel="noopener noreferrer">
                        View Design
                      </a>
                    </Button>
                    <Button
                      ...
                      asChild
                    >
                      <a href={(project as any).case} target="_blank" rel="noopener noreferrer">
                        Case Study
                      </a>
                    </Button>
                  </>
