    ...
    >
      ...
      <div className="max-w-6xl mx-auto w-full relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
          ...
          <div
            className="lg:col-span-4 flex flex-col sm:flex-row lg:flex-col items-start lg:items-end gap-4 w-full pointer-events-auto"
          ...
          >
            <MagneticButton
              size="lg"
              variant="outline"
              className="font-label text-xs tracking-wider uppercase font-semibold w-full sm:w-auto lg:w-full max-w-[200px]"
              onClick={(e) => {
                e.stopPropagation();
