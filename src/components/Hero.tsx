    ...
    >
      <div className="max-w-4xl w-full">
        <div className="flex flex-col items-center gap-8">
          ...
          >
            <div
              className={`relative py-6 px-8 mode-transition ${
                isEngineer
            ...
            >
              <div className="w-72 h-72 md:w-96 md:h-96 bg-muted flex items-center justify-center group cursor-pointer">
                <img
                  src={
                    isEngineer
                      ? `${import.meta.env.BASE_URL}images/hero-engineer.png`
                      : `${import.meta.env.BASE_URL}images/hero-designer.png`
                  }
          ...
          >
            <div className="flex items-center justify-center gap-3 flex-wrap">
              <div
                className={`px-4 py-2 mode-transition font-body ${
                  isEngineer
              ...
              >
                <span
                  className={`font-semibold mode-transition ${
                    isEngineer
